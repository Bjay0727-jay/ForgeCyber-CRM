          ...
          <table className="w-full">
            <thead>
              <tr className="bg-forge-bg-subtle">
                ...
                <th className="text-left uppercase text-[11px] font-semibold text-forge-text-muted py-3 px-4 tracking-wider">Progress</th>
                <th className="text-left uppercase text-[11px] font-semibold text-forge-text-muted py-3 px-4 tracking-wider">Consultant</th>
                <th className="text-left uppercase text-[11px] font-semibold text-forge-text-muted py-3 px-4 tracking-wider">Action</th>
              </tr>
            </thead>
            <tbody>
                ...
                >
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-semibold text-forge-text-muted min-w-[36px]">{assessment.progress}%</span>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-sm text-forge-text-muted">{assessment.consultant}</td>
                  <td className="py-4 px-4">
                    <button
