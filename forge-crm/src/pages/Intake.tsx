...
const getInputClasses = (hasError: boolean): string =>
  [
    ...
    'font-[family-name:var(--font-body)] text-forge-text bg-white',
...
export default function Intake() {
  ...
  return (
    <Card>
      {showSuccess && (
        <div className="mb-6 flex items-center gap-3 rounded-xl border border-forge-success/30 bg-forge-success/10 px-5 py-4">
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-2 gap-5">
              <div>
                ...
                {errors.organization?.name && (
                  <p className="text-forge-danger text-xs mt-1">
              ...
              <div>
                ...
                {errors.organization?.sector && (
                  <p className="text-forge-danger text-xs mt-1">
                    {errors.organization.sector.message}
                  </p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                {...register('organization.cityStateZip')}
              />
            </div>
            <div className="grid grid-cols-2 gap-5">
              <div>
              ...
              <div>
                ...
                <select
                  className={getInputClasses(false)}
                  {...register('organization.employeeCount')}
                >
