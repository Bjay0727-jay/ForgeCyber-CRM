    ...
    <div>
      <div className="grid grid-cols-4 gap-6 mb-8">
        {summaryStats.map((stat) => (
          <div key={stat.label} className="bg-white rounded-2xl border border-forge-border p-6">
      ...
      <Card
        ...
        noPadding
        action={
          <button className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border border-forge-border bg-white text-forge-navy hover:bg-forge-bg hover:border-forge-teal transition-all">
            Export Report
          </button>
        }
      >
        <table className="w-full border-collapse">
          <thead>
            <tr>
              <th className="text-left py-3.5 px-4 text-[11px] font-semibold text-forge-text-muted uppercase tracking-wider border-b border-forge-border bg-forge-bg">Customer</th>
              <th className="text-left py-3.5 px-4 text-[11px] font-semibold text-forge-text-muted uppercase tracking-wider border-b border-forge-border bg-forge-bg">Type</th>
              <th className="text-left py-3.5 px-4 text-[11px] font-semibold text-forge-text-muted uppercase tracking-wider border-b border-forge-border bg-forge-bg">Consultant</th>
              <th className="text-left py-3.5 px-4 text-[11px] font-semibold text-forge-text-muted uppercase tracking-wider border-b border-forge-border bg-forge-bg">Hours Used</th>
              <th className="text-left py-3.5 px-4 text-[11px] font-semibold text-forge-text-muted uppercase tracking-wider border-b border-forge-border bg-forge-bg">Status</th>
              <th className="text-left py-3.5 px-4 text-[11px] font-semibold text-forge-text-muted uppercase tracking-wider border-b border-forge-border bg-forge-bg">Revenue</th>
            </tr>
          </thead>
          <tbody>
